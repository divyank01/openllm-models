...
class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "mistralai/Mistral-Small-24B-Instruct-2501"
...
@bentoml.service(
    ...
    labels=dict(generator="openllm", owner="bentoml-team", aliases="24b-2501"),
...
class LLM:
    model = bentoml.models.HuggingFaceModel(
        bento_args.openllm_model_id, exclude=["consolidated*", "*.pth", "*.pt", "original/**/*"]
    )
