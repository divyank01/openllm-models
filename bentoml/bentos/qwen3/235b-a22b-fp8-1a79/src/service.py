...
class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "Qwen/Qwen3-235B-A22B-FP8"
...
@bentoml.service(
    name="qwen3",
    traffic={"timeout": 300},
    resources={"gpu": 4, "gpu_type": "nvidia-tesla-h100"},
    envs=[
        {"name": "HF_HUB_DISABLE_PROGRESS_BARS", "value": "1"},
        {"name": "VLLM_ATTENTION_BACKEND", "value": "FLASH_ATTN"},
        {"name": "VLLM_USE_V1", "value": "1"},
    ],
    labels=dict(generator="openllm", owner="bentoml-team", aliases="235b-moe"),
