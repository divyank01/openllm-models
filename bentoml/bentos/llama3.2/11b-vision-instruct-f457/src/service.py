...
class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "meta-llama/Llama-3.2-11B-Vision-Instruct"
...
@bentoml.service(
    ...
    labels=dict(generator="openllm", owner="bentoml-team", aliases="11b"),
...
class LLM:
    model = bentoml.models.HuggingFaceModel(
        bento_args.openllm_model_id, exclude=["original", "*.pth", "*.pt", "original/**/*"]
    )
