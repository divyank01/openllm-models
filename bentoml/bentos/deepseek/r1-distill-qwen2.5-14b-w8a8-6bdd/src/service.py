...
class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "neuralmagic/DeepSeek-R1-Distill-Qwen-14B-quantized.w8a8"
...
@bentoml.service(
    ...
    labels=dict(generator="openllm", owner="bentoml-team", aliases="r1-qwen2.5-14b-w8a8"),
