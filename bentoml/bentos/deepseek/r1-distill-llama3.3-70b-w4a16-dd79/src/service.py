...
class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "neuralmagic/DeepSeek-R1-Distill-Llama-70B-quantized.w4a16"
...
@bentoml.service(
    ...
    labels=dict(generator="openllm", owner="bentoml-team", aliases="r1-llama3.3-70b-w4a16"),
