...
class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "meta-llama/Llama-4-Scout-17B-16E-Instruct"
    ...
    max_model_len: int = 1000000
    override_generation_config: dict[str, typing.Any] = {"attn_temperature_tuning": True}
...
class LLM:
    model = bentoml.models.HuggingFaceModel(
        bento_args.openllm_model_id, exclude=["original", "consolidated*", "*.pth", "*.pt", "original/**/*"]
    )
