...
class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "google/gemma-2-2b-it"
...
@bentoml.service(
    name="gemma2",
    traffic={"timeout": 300},
    resources={"gpu": 1, "gpu_type": "nvidia-rtx-3060"},
    envs=[
        {"name": "HF_TOKEN"},
    ...
    labels=dict(generator="openllm", owner="bentoml-team", aliases="2b"),
